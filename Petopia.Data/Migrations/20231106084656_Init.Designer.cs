            ...
            modelBuilder.Entity("Petopia.Data.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("IsCreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 6, 15, 46, 56, 489, DateTimeKind.Local).AddTicks(3865));
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("007295d5-4d83-441f-b545-1ee471c0f8cf"),
            ...
            modelBuilder.Entity("Petopia.Data.Entities.UserConnection", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("AccessTokenExpirationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 11, 6, 15, 46, 56, 491, DateTimeKind.Unspecified).AddTicks(546), new TimeSpan(0, 7, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("RefreshTokenExpirationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 11, 6, 15, 46, 56, 491, DateTimeKind.Unspecified).AddTicks(1228), new TimeSpan(0, 7, 0, 0, 0)));
